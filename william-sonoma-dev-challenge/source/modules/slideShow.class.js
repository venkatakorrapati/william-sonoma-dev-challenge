...
class SlideShow {
  ...
  constructor(props) {
    ...
    this.show = () => {
      ...
      note.innerText = 'Click anywhere else to close';
      ...
      // left click
      const indicatorleft = document.createElement('indicator');
      indicatorleft.classList.add('indicatorleft');
      indicatorleft.innerText = `<<<`;
      indicatorleft.onclick = this.prev;
      modal.appendChild(indicatorleft);
      ...
      // right click
      const indicatorright = document.createElement('indicator');
      indicatorright.innerText = `>>>`;
      indicatorright.classList.add('indicatorright');
      indicatorright.onclick = this.next;
      modal.appendChild(indicatorright);
    };
